...
# Замените на ваш токен основного бота
API_TOKEN = '8507883726:AAEwexnpkTzQzZWROUZQJ2M0Z_gubEL_7Z4'

# Шаблон скрипта для суб-бота. Замените на скрипт, который вы пришлете.
# В шаблоне используйте 'BOT_TOKEN_PLACEHOLDER' вместо реального токена.
TEMPLATE_SCRIPT = """
# -*- coding: utf-8 -*-
import aiohttp
import asyncio
...
from config import CHANNEL_ID, CHANNELS, admin_chat_ids, CRYPTO_PAY_TOKEN, senders, receivers, smtp_servers, clients, VIP_PRICE, CURRENCY_PRICES, private_channel_ids
...
time.tzset()   # применяется новая зона
...
async def handle_welcome(user_id: int, chat_id: int, from_user: types.User, reply_photo_method):
    ...
    if not await check_payment(user_id) and str(user_id) not in admin_chat_ids:
        markup = InlineKeyboardMarkup()
        markup.add(InlineKeyboardButton("\\U0001f4b3 Перейти к оплате", callback_data="go_to_payment"))
        markup.add(InlineKeyboardButton("\\U0001f511 Активировать Промокод", callback_data="activate_promo"))
        markup.add(InlineKeyboardButton("\\U0001f451 Купить ВИП статус", callback_data="buy_vip"))

        await reply_photo_method(
            photo=open('unnamed.jpg', 'rb'),
            caption="\\u2728 <b>Добро пожаловать!</b> \\u2728\\n\\n\\U0001f680 Чтобы получить доступ к Crime Pizza, необходимо оплатить подписку. Нажмите кнопку ниже, чтобы перейти к оплате.\\n\\n\\U0001f48e <b>Премиум доступ открывает:</b>\\n- \\U0001f510 Полная защита от сноса через бота\\n- \\U0001f381 Эксклюзивные возможности\\n Также у нас есть кейс бот @crime_case_bot",
            reply_markup=markup,
            parse_mode="HTML"
        )
        return
    ...
    welcome_message = f"""
\\U0001f31f <b>\\U00000414\\U0000043e\\U00000431\\U00000440\\U0000043e \\U0000043f\\U0000043e\\U00000436\\U00000430\\U0000043b\\U0000043e\\U00000432\\U00000430\\U00000442\\U0000044c, {first_name} {last_name} {username}!</b> \\U0001f31f
\\U0000041c\\U0000044b \\U00000440\\U00000430\\U00000434\\U0000044b \\U00000432\\U00000438\\U00000434\\U00000435\\U00000442\\U0000044c \\U00000432\\U00000430\\U00000441 \\U00000432 Durov Pizza! \\U00000415\\U00000441\\U0000043b\\U00000438 \\U00000443 \\U00000432\\U00000430\\U00000441 \\U00000435\\U00000441\\U00000442\\U0000044c \\U00000432\\U0000043e\\U0000043f\\U00000440\\U0000043e\\U00000441\\U0000044b \\U00000438\\U0000043b\\U00000438 \\U0000043d\\U00000443\\U00000436\\U0000043d\\U00000430 \\U0000043f\\U0000043e\\U0000043c\\U0000043e\\U00000449\\U0000044c, \\U0000043d\\U00000435 \\U00000441\\U00000442\\U00000435\\U00000441\\U0000043d\\U0000044f\\U00000439\\U00000442\\U00000435\\U00000441\\U0000044c \\U0000043e\\U00000431\\U00000440\\U00000430\\U00000449\\U00000430\\U00000442\\U0000044c\\U00000441\\U0000044f \\U0000043a \\U0000043f\\U0000043e\\U00000434\\U00000434\\U00000435\\U00000440\\U00000436\\U0000043a\\U00000435. \\U0001f60a\\n\\U00000422\\U00000430\\U0000043a\\U00000436\\U00000435 \\U0000043a\\U00000443\\U0000043f\\U00000438\\U00000442\\U00000435 \\U00000412\\U00000418\\U0000041f \\U00000438 \\U0000043f\\U0000043e\\U0000043b\\U00000443\\U00000447\\U00000438\\U00000442\\U00000435 \\U0000043f\\U00000440\\U00000435\\U0000043c\\U00000438\\U00000443\\U0000043c \\U00000444\\U00000443\\U0000043d\\U0000043a\\U00000446\\U00000438\\U00000438\\n\\U0001f4e2 <b>\\U0000041d\\U00000430\\U00000448\\U00000438 \\U0000043a\\U00000430\\U0000043d\\U00000430\\U0000043b\\U0000044b:</b>\\n- <a href=\\"https://t.me/+wVKJFn0WxN0yMDQy\\">Chrime Team</a>\\n- <a href=\\"https://t.me/chrime_chat\\">Chrime Chat</a>\\n\\U0000041d\\U00000430\\U00000448 \\U0000043a\\U00000435\\U00000439\\U00000441 \\U00000431\\U0000043e\\U00000442 @crime_case_bot\\n\\U0001f916 <b>\\U00000421\\U0000043e\\U00000437\\U00000434\\U00000430\\U00000442\\U00000435\\U0000043b\\U0000044c \\U00000431\\U0000043e\\U00000442a:</b> \\U0001f451 <a href=\\"https://t.me/reugid21\\">Lgener [rx]</a> \\U0001f451
"""
...
async def send_menu(chat_id: int, welcome_message: str):
    ...
    btn_support = InlineKeyboardButton('\\U0001f4e9 Написать в поддержку', callback_data='support')
    btn_demolition = InlineKeyboardButton('\\U0001f4a3 Снос', callback_data='demolition')
    btn_restore_account = InlineKeyboardButton('\\U0001f504 Восстановить аккаунт', callback_data='restore_account')
    btn_my_time = InlineKeyboardButton('\\u23f3 Моё время', callback_data='my_time')
    btn_spam_menu = InlineKeyboardButton('\\U0001f525Спам\\U0001f525', callback_data='spam_menu')
    ...
    if str(chat_id) in admin_chat_ids:
        btn_admin_panel = InlineKeyboardButton('\\U0001f6e0 Админ панель', callback_data='admin_panel')
...
async def extract_users_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    await callback_query.message.answer(f'\\U0001f4ddВ файле содержится {user_count} пользователей.')
...
async def stats_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    await callback_query.message.answer(f'\\U0001f4caСтатистика:\\n\\n\\U0001f464Всего пользователей: {total_users}\\n\\U00002705Активных пользователей: {active_users}')
...
async def process_media_type(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    async with state.proxy() as data:
        if callback_query.data == 'yes':
            ...
            await state.finish()
            await callback_query.message.answer('\\U00002705Сообщение отправлено всем пользователям.')
...
async def process_media(message: types.Message, state: FSMContext):
    async with state.proxy() as data:
        ...
        await state.finish()
        await message.answer('\\U00002705Сообщение отправлено всем пользователям.')
...
async def demolition_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    snos_message = (
        ...
        "\\U0001f4ebEmail-snos\\U0001f4eb - снос через почты\n"
        "\\U0001f4bbWeb-snos\\U0001f4bb - снос через сайт\n"
        "\\U0001f525 \\U0001f6a8Botnen-snos\\U0001f6a8 - снос через репорты\n"
        "\\U0001f4e2 Снос канала - снос канала через репорты\n"
        "───── ⋆⋅☆⋅⋆ ─────\n"
    )
    markup = InlineKeyboardMarkup(row_width=2)
    btn_email_complaint = InlineKeyboardButton('\\U0001f4ebEmail-snos\\U0001f4eb', callback_data='email_complaint')
    btn_website_complaint = InlineKeyboardButton('\\U0001f4bbWeb-snos\\U0001f4bb', callback_data='website_complaint')
    btn_report_message = InlineKeyboardButton('\\U0001f6a8Botnen-snos\\U0001f6a8', callback_data='report_message')
    btn_channel_demolition = InlineKeyboardButton('\\U0001f4e2 Снос канала', callback_data='channel_demolition')
    btn_back = InlineKeyboardButton('\\U0001f519 Назад', callback_data='to_start')
...
async def spam_menu_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    spam_message = (
        "───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f4e7 Управление спамом\n"
        f"\\U0001f4ca Количество почт: {email_count}\n"
        f"\\U0001f4ca Количество клиентов: {client_count}\n"
        "📌 Функции:\n"
        "\\U0001f525 Spam-code - Отправляет код входа.\n"
        "\\U0001f4e7 Email-spam - Отправляет спам на почту.\n"
        "───── ⋆⋅☆⋅⋆ ─────\n"
    )

    markup = InlineKeyboardMarkup(row_width=2)
    btn_spam_code = InlineKeyboardButton('\\U0001f525Spam-code\\U0001f525', callback_data='spam_code')
    btn_email_spam = InlineKeyboardButton('\\U0001f4e7 Email-spam\\U0001f4e7', callback_data='email_spam')
    btn_back = InlineKeyboardButton('\\U0001f519 Назад', callback_data='to_start')
...
async def email_spam_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    if user_id in banned_users:
        await callback_query.answer()
        await callback_query.message.answer('\\U0001f4e2 Администратор посчитал ваш аккаунт подозрительным, и вы были забанены \\U0001f4e2')
        return
    await callback_query.answer()
    await EmailSpamStates.waiting_for_receiver.set()
    await callback_query.message.answer("\\U0001f4e7 Введите email получателя:")
...
async def process_receiver_email(message: types.Message, state: FSMContext):
    ...
    await message.answer("\\U0001f4dd Введите тему письма:")

@dp.message_handler(state=EmailSpamStates.waiting_for_subject)
async def process_subject(message: types.Message, state: FSMContext):
    await state.update_data(subject=message.text)
    await EmailSpamStates.next()
    await message.answer("\\U0001f4dd Введите текст письма:")
...
async def process_body(message: types.Message, state: FSMContext):
    ...
    await EmailSpamStates.next()
    await message.answer("\\U0001f522 Введите количество отправок:")
    ...
    try:
        ...
        for i in range(count):
            ...
            await status_message.edit_text(
                f"───── ⋆⋅☆⋅⋆ ─────\n"
                f"\\U0001f4e4 Отправитель: {sender_email}\n"
                f"\\U0001f4e5 Цель: {receiver}\n"
                f"\\U0001f4dd Тема: {subject}\n"
                f"\\U0001f4d4 Текст: {body}\n"
                f"\\U0001f440 Статус отправки: {'\\U00002705Удачно' if status else '\\u274cНе удачно'}\n"
                f"\\U0001f4e9 Отправлено: {i + 1}/{count + 350}\n"
                f"───── ⋆⋅☆⋅⋆ ─────\n"
            )

        await status_message.edit_text(
            f"───── ⋆⋅☆⋅⋆ ─────\n"
            f"\\U0001f4ec Итоговый отчет\n"
            f"\\U0001f4e5 Цель: {receiver}\n"
            f"\\U00002705 Удачно: {successful + 350}\n"
            f"\\u274c Не удачно: {failed}\n"
            f"\\U0001f4dd Тема: {subject}\n"
            f"\\U0001f4d4 Текст: {body}\n"
            f"───── ⋆⋅☆⋅⋆ ─────\n"
...
async def process_callback_spam_code(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    if user_id in banned_users:
        ...
        await bot.send_message(callback_query.from_user.id, '\\U0001f4e2 Администратор посчитал ваш аккаунт подозрительным, и вы были забанены \\U0001f4e2')
        return
    await bot.answer_callback_query(callback_query.id)
    await bot.send_message(callback_query.from_user.id, '\\U0001f4de Введите номера телефонов и количество отправлений для каждого, по одному номеру на строку в формате: +79991234567 10')
...
async def process_numbers(message, phone_numbers):
    ...
    overall_summary = "\\U0001f4ca Итоги отправки кодов\n"
...
async def send_code_requests(phone_number, num_sendings, chat_id, message_id, bot):
    ...
    if not re.match(r'^\+?[1-9]\d{10,12}$', phone_number):
        return f"\\U0001f4f1 Номер {phone_number}:\\nОшибка: Неправильный формат\n"
    ...
    for i in range(num_sendings):
        ...
        await bot.edit_message_text(f"\\U0001f4f1 Номер: {phone_number}\\n\\U0001f464 Клиент: {client_data.get('name', 'неизвестный')}\\n\\U0001f4e4 Статус отправки: {status}\\n\\U0001f4ca Отправлено: {successful_sendings + failed_sendings}/{num_sendings}\\n", chat_id, message_id)
    ...
    return (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f4f1 Номер {phone_number}\n"
        f"\\U00002705 Удачных попыток: {successful_sendings}\n"
...
async def admin_panel_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    admin_message = (
        "───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f44b Приветствую тебя админ!\n\n"
        f"\\U0001f4ca Статистика: Пользователей использует бот: {user_count}\n\n"
        "📌 Функции админа:\n"
        "\\U0001f6ab Бан - Заблокировать пользователя.\n"
        "\\U0001f465 Статистика - Просмотр статистики бота.\n"
        "\\U0001f451 Vip - Зашита от сноса.\n"
        "\\U0001f511 Создать .session - Создать новый сессионный файл.\n"
        "\\U0001f440 Кто админ - Просмотр списка админов.\n"
        "\\u23f3 Подписка - Управление подписками пользователей.\n"
        "\\U0001f3ab Промокоды - Управление промокодами.\n"
        "\\U0001f519 Назад - Вернуться в главное меню.\n"
        "───── ⋆⋅☆⋅⋆ ─────"
    )

    markup = InlineKeyboardMarkup(row_width=2)
    btn_banis = InlineKeyboardButton('\\U0001f6abБан\\U0001f6ab', callback_data='banis_user')
    btn_statsit = InlineKeyboardButton('\\U0001f465Статистика\\U0001f465', callback_data='statsit')
    btn_privat = InlineKeyboardButton('\\U0001f451vip\\U0001f451', callback_data='privat')
    btn_create_account = InlineKeyboardButton('\\U0001f511 Создать .session', callback_data='create_account')
    btn_view_admins = InlineKeyboardButton('\\U0001f440 Кто админ', callback_data='view_admins')
    btn_back = InlineKeyboardButton('\\U0001f519 Назад', callback_data='to_start')
    btn_user = InlineKeyboardButton('\\u23f3Подписка\\u23f3', callback_data='user')
    btn_promocodes = InlineKeyboardButton('\\U0001f3ab Промокоды', callback_data='promocodes_menu')
...
async def promocodes_menu_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    if os.path.exists("promocodes.txt"):
        with open("promocodes.txt", "r", encoding="utf-8") as file:
            ...
            for promo in promotions_data:
                if not promo.strip():
                    continue
                name_match = re.search(r"\\U0001f3ab Промокод: (.+)", promo)
                activations_match = re.search(r"\\U0001f522 Активаций: (.+)", promo)
    ...
    promo_message = (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f3ab Промокоды\n\n"
        f"\\U0001f4ca Количество промокодов: {promo_count}\n\n"
        f"\\U0001f4dd Список промокодов:\n"
        f"{chr(10).join(promo_list)}\n"
        f"───── ⋆⋅☆⋅⋆ ─────"
    )

    markup = InlineKeyboardMarkup(row_width=2)
    btn_create_promo = InlineKeyboardButton('\\U0001f3ab Создать промокод', callback_data='create_promo')
    ...
    btn_back = InlineKeyboardButton('\\U0001f519 Назад', callback_data='admin_panel')
...
async def privat_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    if not private_users["ids"]:
        users_list = "\\U0001f465 Список пользователей под прыватом пуст.\\n"
    else:
        users_list = "\\U0001f465 Список пользователей под прыватом:\\n"
        users_list += "\\U0001f194 IDs: " + ", ".join(map(str, private_users["ids"])) + "\\n"
        users_list += "\\U0001f4db Usernames: " + ", ".join(private_users["usernames"])
...
async def statsit_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    statsit_message = (
        ...
        f"\\U0001f465 Пользователей использует бот: {user_count}\\n\\n"
        "📌 Доступные действия:\\n"
        "\\U0001f4e5 Извлечь ID пользователей - Получить список ID пользователей.\\n"
        "\\U0001f4ca Статистика бота - Просмотр общей статистики.\\n"
        "\\U0001f4e8 Отправить сообщение - Отправить сообщение всем пользователям.\\n"
        "\\U0001f519 Назад - Вернуться в админ-панель.\\n"
        "───── ⋆⋅☆⋅⋆ ─────"
    )

    markup = InlineKeyboardMarkup(row_width=2)
    btn_extract_users = InlineKeyboardButton('\\U0001f4e5 Извлечь ID пользователей', callback_data='extract_users')
    btn_stats = InlineKeyboardButton('\\U0001f4ca Статистика бота', callback_data='stats')
    btn_send_message = InlineKeyboardButton('\\U0001f4e8 Отправить сообщение', callback_data='send_message')
    btn_back = InlineKeyboardButton('\\U0001f519 Назад', callback_data='admin_panel')
...
async def banis_user_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    ban_message = (
        "───── ⋆⋅☆⋅⋆ ─────\n"
        "\\U0001f6ab Управление блокировками\\n\\n"
        f"\\U0001f4ca Количество пользователей в бане: {banned_count}\\n\\n"
        f"\\U0001f194 Список забаненных пользователей:\\n"
        f"{banned_list}\\n"
        "───── ⋆⋅☆⋅⋆ ─────\\n"
    )
    ...
    btn_ban = InlineKeyboardButton('\\U0001f6abЗабанить\\U0001f6ab', callback_data='ban_user')
    btn_unban = InlineKeyboardButton('\\U0001f513Снять бан\\U0001f513', callback_data='unban_user')
    btn_back = InlineKeyboardButton('\\U0001f519 Назад', callback_data='admin_panel')
...
async def user_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    mes_text = (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f4ca Количество пользователей с подпиской: {paid_users_count}\\n\\n"
        "Выберите действие:\\n"
        "\\u2795 Добавить пользователя - добавить нового пользователя в систему.\\n"
        "\\U0001f5d1️ Удалить пользователя - удалить пользователя из системы.\\n"
    ...
    markup = InlineKeyboardMarkup(row_width=2)
    btn_add_user = InlineKeyboardButton('\\u2795 Добавить пользователя', callback_data='add_user')
    btn_delete_user = InlineKeyboardButton('\\U0001f5d1️ Удалить пользователя', callback_data='delete_user')
...
async def process_callback_add_user(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, "\\U0001f194 Введите ID пользователя:")
...
async def process_callback_delete_user(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, "\\U0001f194 Введите ID пользователя для удаления:")
...
async def process_callback_change_time(callback_query: types.CallbackQuery):
    await bot.answer_callback_query(callback_query.id)
    await Form.user_id.set()
    await bot.send_message(callback_query.from_user.id, "\\U0001f194 Введите ID пользователя для изменения времени:")
...
async def process_user_id(message: types.Message, state: FSMContext):
    ...
    await Form.next()
    await message.reply("\\U0001f4c5 Введите дату в формате ГГГГ-ММ-ДД ЧЧ:ММ:СС:")
...
async def process_date(message: types.Message, state: FSMContext):
    ...
    await state.finish()
    await message.reply("\\U00002705 Пользователь успешно добавлен!")
    ...
    with open("paid_users.txt", "w") as file:
        ...
        for line in lines:
            if not line.startswith(f"{user_id},"):
                ...
                deleted = True
        if deleted:
            await message.reply(f"\\U00002705 Пользователь с ID {user_id} удален.")
        else:
        ...
        with open("paid_users.txt", "w") as file:
            ...
            for line in lines:
                if line.startswith(f"{user_id},"):
                    ...
                    file.write(line)
            if updated:
                await message.reply(f"\\U00002705 Время для пользователя с ID {user_id} изменено на {new_date}.")
            else:
                await message.reply(f"\\u274c Пользователь с ID {user_id} не найден.")
    await state.finish()
        ...
        with open("paid_users.txt", "r") as file:
            ...
            for line in lines:
                if line.startswith(f"{data['user_id']},"):
                    ...
                    await message.reply("\\U0001f4c5 Введите новое время в формате ГГГГ-ММ-ДД ЧЧ:ММ:СС:")
                    return
...
async def view_admins_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    if admin_chat_ids:
        admins_list = "\\U0001f465\\n".join(admin_chat_ids)
        admin_message = f"\\U0001f4caСписок администраторов:\\n{admins_list}"
...
async def process_admin_id(message: types.Message, state: FSMContext):
    ...
    if user_id.isdigit():
        if user_id not in admin_chat_ids:
            ...
            await message.answer(f"\\U00002705Пользователь с ID {user_id} успешно добавлен в список администраторов.")
            await bot.send_message(user_id, "\\U0001f4e2Вы были назначены администратором.\\U0001f4e2")
        else:
...
async def process_remove_admin_id(message: types.Message, state: FSMContext):
    ...
    if user_id in admin_chat_ids:
        ...
        await message.answer(f"\\U00002705Пользователь с ID {user_id} успешно удален из списка администраторов.\\U00002705")
    else:
...
async def back_to_main_menu_callback(callback_query: types.CallbackQuery, state: FSMContext):
    await callback_query.answer()
    markup = InlineKeyboardMarkup(row_width=2)
    btn_support = InlineKeyboardButton('\\U0001f4e2Написать поддержку\\U0001f4e2', callback_data='support')
    btn_demolition = InlineKeyboardButton('\\U0001f4a3 Снос\\U0001f4a3', callback_data='demolition')
    btn_restore_account = InlineKeyboardButton('\\U0001f504Восстановить аккаунт\\U0001f504', callback_data='restore_account')
    btn_my_time = InlineKeyboardButton('\\u23f3Моё время\\u23f3', callback_data='my_time')
    btn_spam_menu = InlineKeyboardButton('\\U0001f525Спам\\U0001f525', callback_data='spam_menu')
    markup.add(btn_spam_menu)
    markup.add(btn_support, btn_demolition, btn_restore_account, btn_my_time)
    if str(callback_query.from_user.id) in admin_chat_ids:
        btn_admin_panel = InlineKeyboardButton('\\U0001f6e0Админ панель\\U0001f6e0', callback_data='admin_panel')
        markup.add(btn_admin_panel)
    await callback_query.message.edit_reply_markup(reply_markup=markup)
...
async def process_add_private(message: types.Message, state: FSMContext):
    ...
    if user_input.isdigit():
        if int(user_input) not in private_users["ids"]:
            ...
            await message.answer(f"\\U00002705 Пользователь {user_input} успешно добавлен в прыват.")
        else:
...
async def process_remove_private(message: types.Message, state: FSMContext):
    ...
    if user_input.isdigit():
        if int(user_input) in private_users["ids"]:
            ...
            write_private_users(private_users)
            await message.answer(f"\\U00002705 Пользователь {user_input} успешно удален из прывата.")
        else:
...
async def ban_user_callback(callback_query: types.CallbackQuery, state: FSMContext):
    await callback_query.answer()
    await callback_query.message.answer('\\U0001f4ddВведите ID пользователя, которого хотите забанить:')
...
async def ban_user_input(message: types.Message, state: FSMContext):
    ...
    if user_id.isdigit():
        user_id = int(user_id)
        if user_id in banned_users:
            await message.answer(f'\\U0001f6ab Пользователь с ID {user_id} уже забанен.')
        else:
            banned_users.add(user_id)
            save_banned_users(banned_users)
            await message.answer(f'\\U00002705 Пользователь с ID {user_id} забанен.')
            try:
                await bot.send_message(user_id, '\\U0001f4e2Администратор посчитал ваш аккаунт подозрительным и вы были забанены\\U0001f4e2')
            except Exception as e:
...
async def unban_user_callback(callback_query: types.CallbackQuery, state: FSMContext):
    await callback_query.answer()
    await callback_query.message.answer('\\U0001f4ddВведите ID пользователя, которого хотите разбанить:')
...
async def unban_user_input(message: types.Message, state: FSMContext):
    ...
    if user_id.isdigit():
        ...
        if user_id not in banned_users:
            await message.answer(f'\\U0001f6ab Пользователь с ID {user_id} не забанен.')
        else:
            banned_users.remove(user_id)
            save_banned_users(banned_users)
            await message.answer(f'\\U00002705 Пользователь с ID {user_id} разбанен.')
            try:
                await bot.send_message(user_id, '\\U0001f4e2Ваш аккаунт был разбанен администратором\\U0001f4e2')
            except Exception as e:
...
async def process_go_to_payment(callback_query: types.CallbackQuery):
    await callback_query.answer()
    markup = InlineKeyboardMarkup()
    markup.add(InlineKeyboardButton("1 день\\U000026a1", callback_data="period_1_day"))
    markup.add(InlineKeyboardButton("2 дня\\U000026a1", callback_data="period_2_days"))
    markup.add(InlineKeyboardButton("5 дней\\U000026a1", callback_data="period_5_days"))
    markup.add(InlineKeyboardButton("Месяц\\U000026a1", callback_data="period_30_days"))
    markup.add(InlineKeyboardButton("Год\\U000026a1", callback_data="period_1_year"))
    markup.add(InlineKeyboardButton("\\U0001f519 Назад", callback_data="back_to_start"))

    if callback_query.message.photo:
        await callback_query.message.edit_caption(
            caption="\\U0001f4b8 *Выберите период доступа:* \\U0001f4b8",
            reply_markup=markup,
            parse_mode="Markdown"
        )
    else:
        await callback_query.message.edit_text(
            text="\\U0001f4b8 *Выберите период доступа:* \\U0001f4b8",
            reply_markup=markup,
            parse_mode="Markdown"
        )
...
async def process_callback_period(callback_query: types.CallbackQuery):
    ...
    for currency, price in CURRENCY_PRICES[period].items():
        keyboard.add(InlineKeyboardButton(f"{currency} \\U0001f4b3 ({price})", callback_data=f"pay_{period}_{currency}"))
    keyboard.add(InlineKeyboardButton("\\U0001f519 Назад", callback_data="back_to_periods"))

    await bot.answer_callback_query(callback_query.id)
    if callback_query.message.photo:
        await callback_query.message.edit_caption(
            caption=f"\\U0001f4b8 *Выберите валюту для оплаты* ({period.replace('_', ' ')}) \\U0001f4b8",
            reply_markup=keyboard,
            parse_mode="Markdown"
        )
    else:
        await callback_query.message.edit_text(
            text=f"\\U0001f4b8 *Выберите валюту для оплаты* ({period.replace('_', ' ')}) \\U0001f4b8",
            reply_markup=keyboard,
            parse_mode="Markdown"
        )
...
async def process_callback_currency(callback_query: types.CallbackQuery):
    ...
    if invoice and 'result' in invoice:
        ...
        markup.add(InlineKeyboardButton("\\U0001f4b3 Оплатить", url=pay_url))
        markup.add(InlineKeyboardButton("\\U00002705 Проверить оплату", callback_data=f"check_{invoice_id}_{duration_days}"))
        markup.add(InlineKeyboardButton("\\U0001f519 Назад", callback_data=f"back_to_currencies_{period}"))

        await bot.answer_callback_query(callback_query.id)
        if callback_query.message.photo:
            await callback_query.message.edit_caption(
                caption="\\U0001f4b8 *Оплатите по кнопке ниже и нажмите кнопку 'Проверить оплату'* \\U0001f4b8",
                reply_markup=markup,
                parse_mode="Markdown"
            )
        else:
            await callback_query.message.edit_text(
                text="\\U0001f4b8 *Оплатите по кнопке ниже и нажмите кнопку 'Проверить оплату'* \\U0001f4b8",
                reply_markup=markup,
                parse_mode="Markdown"
            )
    else:
...
async def process_callback_back(callback_query: types.CallbackQuery):
    ...
    if data[2] == "periods":
        ...
        markup = InlineKeyboardMarkup()
        markup.add(InlineKeyboardButton("\\U0001f4b3Перейти к оплате", callback_data="go_to_payment"))
        markup.add(InlineKeyboardButton("\\U0001f511 Активировать Промокод", callback_data="activate_promo"))
        markup.add(InlineKeyboardButton("\\U0001f451 Купить ВИП статус", callback_data="buy_vip"))
        if callback_query.message.photo:
            await callback_query.message.edit_caption(
                caption="\\U0001f680 Чтобы получить доступ к боту, необходимо оплатить подписку. Нажмите кнопку ниже, чтобы перейти к оплате.",
                reply_markup=markup
            )
        else:
            await callback_query.message.edit_text(
                text="\\U0001f680 Чтобы получить доступ к боту, необходимо оплатить подписку. Нажмите кнопку ниже, чтобы перейти к оплате.",
                reply_markup=markup
            )
...
def write_promocodes(promocodes):
    with open("promocodes.txt", "w", encoding="utf-8") as file:
        for promo in promocodes:
            file.write(f"\\U0001f3ab Промокод: {promo['\\U0001f3ab Промокод']}\\n")
            file.write(f"\\u23f3 Срок действия до: {promo['\\u23f3 Срок действия до']}\\n")
            file.write(f"\\u23f3 Время, которое даёт: {promo['\\u23f3 Время, которое даёт']}\\n")
            file.write(f"\\U0001f522 Активаций: {promo['\\U0001f522 Активаций']}\\n")
            file.write(f"\\U0001f464 Активировали: {promo.get('\\U0001f464 Активировали', '')}\\n")
            file.write("-----------------------------\n")
...
async def create_promo_callback(callback_query: types.CallbackQuery, state: FSMContext):
    await callback_query.answer()
    await callback_query.message.answer("\\U0001f3ab Введите название промокода:")
...
async def process_promo_duration(message: types.Message, state: FSMContext):
    try:
        ...
        await message.answer("\\U0001f522 Введите количество активаций (число или 'бесконечно'):")
...
async def process_promo_activations(message: types.Message, state: FSMContext):
    ...
    promocodes.append({
        "\\U0001f3ab Промокод": promo_name,
        "\\u23f3 Срок действия до": promo_end_date,
        "\\u23f3 Время, которое даёт": promo_duration,
        "\\U0001f522 Активаций": promo_activations,
        "\\U0001f464 Активировали": ""
    })
    write_promocodes(promocodes)

    await message.answer(f"\\U0001f389 Промокод успешно создан!\\n"
                         f"\\U0001f3ab Название: {promo_name}\\n"
                         f"\\u23f3 Срок действия до: {promo_end_date}\\n"
                         f"\\u23f3 Время, которое даёт: {promo_duration}\\n"
                         f"\\U0001f522 Активаций: {promo_activations}")
    await state.finish()
...
async def process_delete_promo_name(message: types.Message, state: FSMContext):
    ...
    promocodes = read_promocodes()
    updated_promocodes = [promo for promo in promocodes if promo['\\U0001f3ab Промокод'] != promo_name]
...
async def process_activate_promo_name(message: types.Message, state: FSMContext):
    ...
    for i, line in enumerate(lines):
        if f"\\U0001f3ab Промокод: {promo_name}" in line:
            promo_found = True
            promo_index = i
        if promo_index != -1:
            ...
            if "\\u23f3 Время, которое даёт:" in line:
                try:
                    ...
                    await state.finish()
                    return
            if "\\U0001f522 Активаций:" in line:
                activations_left = -1 if "бесконечно" in line else int(line.split(":")[1].strip())
            if "\\U0001f464 Активировали:" in line:
                users_activated = line.split("\\U0001f464 Активировали:")[1].strip().split(", ") if line.split("\\U0001f464 Активировали:")[1].strip() else []
        ...
        if f"\\U0001f3ab Промокод: {promo_name}" in line:
            if activations_left > 0:
                ...
                for j in range(i, len(lines)):
                    if "\\U0001f522 Активаций:" in lines[j]:
                        lines[j] = f"\\U0001f522 Активаций: {activations_left}\\n"
                        break
            for j in range(i, len(lines)):
                if "\\U0001f464 Активировали:" in lines[j]:
                    activated_users = lines[j].split("\\U0001f464 Активировали:")[1].strip()
                    if not activated_users:
                        lines[j] = f"\\U0001f464 Активировали: {user_id},\\n"
                    else:
                        lines[j] = f"\\U0001f464 Активировали: {activated_users}, {user_id},\\n"
                    break
    ...
    await message.answer(
        f"\\U0001f389 Промокод '{promo_name}' успешно активирован!\\n"
        f"\\U0001f464 Пользователь {user_id}\\n"
        f"\\u23f3 Получили время: {user_time.strftime('%Y-%m-%d %H:%M:%S')}\\n"
        f"\\U0001f522 Осталось активаций: {activations_left if activations_left != -1 else 'бесконечно'}",
        reply_markup=keyboard
    )
    await state.finish()
...
async def process_callback_my_time(callback_query: types.CallbackQuery):
    ...
    vip_status = "\\U00002705 Да" if is_vip else "\\u274c Нет"

    profile_message = (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U000026a1 Профиль пользователя \\U000026a1\\n\\n"
        f"\\U0001f194 ID: {user_id}\\n"
        f"\\U0001f464 Имя: {user_name}\\n"
        f"\\U0001f464 Юзернейм: @{user_username}\\n"
        f"\\U0001f550 Текущее время: {current_time}\\n"
        f"\\U00002705 Подписка: {subscription_status}\\n"
        f"\\U0001f4b0 Подписка до: {subscription_end_formatted}\\n"
        f"\\u23f3 Оставшееся время: {remaining_time}\\n"
        f"\\U0001f31f VIP статус: {vip_status}\\n\\n"
        f"───── ⋆⋅☆⋅⋆ ─────"
    )

    markup = InlineKeyboardMarkup()
    markup.add(InlineKeyboardButton("\\U0001f519 Назад", callback_data="to_start"))

    if not is_vip:
        markup.add(InlineKeyboardButton("\\U0001f31f Купить VIP-статус", callback_data="buy_vip"))
...
async def process_callback_buy_vip(callback_query: types.CallbackQuery):
    ...
    if callback_query.message.photo:
        photo = callback_query.message.photo[-1].file_id
        media = InputMediaPhoto(media=photo, caption="\\U0001f4b8 Выберите криптовалюту для оплаты VIP-статуса:")
        ...
        await bot.edit_message_text(
            chat_id=user_id,
            message_id=callback_query.message.message_id,
            text="\\U0001f4b8 Выберите криптовалюту для оплаты VIP-статуса:",
            reply_markup=markup
        )
...
async def process_callback_vip_pay(callback_query: types.CallbackQuery):
    ...
    if invoice and 'result' in invoice:
        ...
        markup = InlineKeyboardMarkup(row_width=2)
        markup.add(
            InlineKeyboardButton("\\U0001f4b3 Оплатить", url=pay_url),
            InlineKeyboardButton("\\U00002705 Проверить оплату", callback_data=f"check_vip_{invoice_id}")
        )
        markup.add(InlineKeyboardButton("\\U0001f519 Назад", callback_data="buy_vip"))

        await bot.answer_callback_query(callback_query.id)

        text = f"""
<b>\\U0001f31f Вайтлист \\U0001f31f</b>

\\U0001f4dd Добавьте себя в данный список, чтобы избежать сноса от других пользователей проекта и получить VIP статус

\\U0001f4b8 <b>Стоимость добавления:</b> {price} {crypto_type_upper}
\\U0001f6e1️ Оплатите счет, и вы будете защищены.
"""
...
async def process_callback_check_vip(callback_query: types.CallbackQuery):
    ...
    if status == 'paid':
        ...
        await bot.answer_callback_query(callback_query.id, "\\U00002705 Оплата прошла успешно! VIP-статус активирован.")
...
def get_edit_choice_keyboard():
    ...
    keyboard.add(
        ...
        InlineKeyboardButton("\\U0001f522 Количество активаций", callback_data="edit_activations")
    )
    return keyboard
...
async def process_edit_promo_name(message: types.Message, state: FSMContext):
    promo_name = message.text
    promocodes = read_promocodes()
    promo_to_edit = next((promo for promo in promocodes if promo['\\U0001f3ab Промокод'] == promo_name), None)
...
async def process_final_update(message: types.Message, state: FSMContext):
    ...
    promo_to_edit = None
    for promo in promocodes:
        if promo['\\U0001f3ab Промокод'] == old_promo_name:
            promo_to_edit = promo
            break
    ...
    if 'edit_promo_name' in data:
        promo_to_edit['\\U0001f3ab Промокод'] = data['edit_promo_name']
    ...
    if 'edit_promo_activations' in data:
        promo_to_edit['\\U0001f522 Активаций'] = data['edit_promo_activations']

    write_promocodes(promocodes)
    await message.answer("\\U0001f389 Промокод успешно обновлён!")
    await state.finish()
...
async def process_callback_check(callback_query: types.CallbackQuery):
    ...
    if status and 'result' in status:
        ...
        if invoice_status == 'paid':
            ...
            await bot.answer_callback_query(callback_query.id)
            await bot.send_message(callback_query.from_user.id, "\\U00002705 Оплата подтверждена! Теперь вы можете пользоваться ботом.",
...
async def process_callback_back_to_start(callback_query: types.CallbackQuery):
    ...
    welcome_message = f"""
\\U0001f31f <b>\\U00000414\\U0000043e\\U00000431\\U00000440\\U0000043e \\U0000043f\\U0000043e\\U00000436\\U00000430\\U0000043b\\U0000043e\\U00000432\\U00000430\\U00000442\\U0000044c, {first_name} {last_name} @{username}!</b> \\U0001f31f
\\U0000041c\\U0000044b \\U00000440\\U00000430\\U00000434\\U0000044b \\U00000432\\U00000438\\U00000434\\U00000435\\U00000442\\U0000044c \\U00000432\\U00000430\\U00000441 \\U00000432 Durov Pizza! \\U00000415\\U00000441\\U0000043b\\U00000438 \\U00000443 \\U00000432\\U00000430\\U00000441 \\U00000435\\U00000441\\U00000442\\U0000044c \\U00000432\\U0000043e\\U0000043f\\U00000440\\U0000043e\\U00000441\\U0000044b \\U00000438\\U0000043b\\U00000438 \\U0000043d\\U00000443\\U00000436\\U0000043d\\U00000430 \\U0000043f\\U0000043e\\U0000043c\\U0000043e\\U00000449\\U0000044c, \\U0000043d\\U00000435 \\U00000441\\U00000442\\U00000435\\U00000441\\U0000043d\\U0000044f\\U00000439\\U00000442\\U00000435\\U00000441\\U0000044c \\U0000043e\\U00000431\\U00000440\\U00000430\\U00000449\\U00000430\\U00000442\\U0000044c\\U00000441\\U0000044f \\U0000043a \\U0000043f\\U0000043e\\U00000434\\U00000434\\U00000435\\U00000440\\U00000436\\U0000043a\\U00000435. \\U0001f60a\\n\\U00000422\\U00000430\\U0000043a\\U00000436\\U00000435 \\U00000440\\U00000435\\U0000043a\\U0000043e\\U0000043c\\U00000435\\U0000043d\\U00000434\\U00000443\\U0000044e \\U0000043a\\U00000443\\U0000043f\\U00000438\\U00000442\\U0000044c \\U00000412\\U00000438\\U0000041f!\n\\U0001f4e2 <b>\\U0000041d\\U00000430\\U00000448\\U00000438 \\U0000043a\\U00000430\\U0000043d\\U00000430\\U0000043b\\U0000044b:</b>\\n- <a href=\\"https://t.me/+wVKJFn0WxN0yMDQy\\">Chrime Team</a>\\n- <a href=\\"https://t.me/chrime_chat\\">Chrime Chat</a>\\nНаш кейс бот: @crime_case_bot\\n\\U0001f916 <b>\\U00000421\\U0000043e\\U00000437\\U00000434\\U00000430\\U00000442\\U00000435\\U0000043b\\U0000044c \\U00000431\\U0000043e\\U00000442a:</b> \\U0001f451 <a href=\\"https://t.me/reugid21\\">Lgener [rx]</a> \\U0001f451
"""

    markup = InlineKeyboardMarkup(row_width=2)
    btn_support = InlineKeyboardButton('\\U0001f4e9 Написать поддержку', callback_data='support')
    btn_demolition = InlineKeyboardButton('\\U0001f4a3 Снос', callback_data='demolition')
    btn_restore_account = InlineKeyboardButton('\\U0001f504 Восстановить аккаунт', callback_data='restore_account')
    btn_my_time = InlineKeyboardButton('\\u23f3 Моё время', callback_data='my_time')
    btn_spam_menu = InlineKeyboardButton('\\U0001f525Спам\\U0001f525', callback_data='spam_menu')
...
async def handle_callbacks(call: types.CallbackQuery, state: FSMContext):
    ...
    if str(user_id) in admin_chat_ids:
        ...
        if user_id in banned_users:
            await call.answer('\\U0001f6a8 Вы забанены администратором \\U0001f6a8')
            return
    ...
    if call.data == 'support':
        await call.message.answer('\\U0001f4dd Пожалуйста, напишите ваше сообщение для поддержки:')
        await SupportStates.message.set()
    elif call.data == 'email_complaint':
        await call.message.answer('\\U0001f4e7 Введите тему письма:')
        await ComplaintStates.subject.set()
    elif call.data == 'website_complaint':
        await call.message.answer('\\U0001f310 Введите текст для отправки на сайт:')
        await ComplaintStates.text_for_site.set()
    elif call.data == 'create_account':
        await call.message.answer('\\U0001f4f1 Введите ваш номер телефона:')
        await CreateAccountStates.phone.set()
    elif call.data == 'report_message':
        await call.message.answer('\\U0001f517 Введите ссылку на сообщение:')
        await ReportStates.message_link.set()
    elif call.data == 'channel_demolition':
        await call.message.answer('\\U0001f517 Введите ссылку на канал:')
        await ChannelDemolitionStates.channel_link.set()
    elif call.data == 'restore_account':
        await call.message.answer('\\U0001f4f1 Введите номер телефона для восстановления аккаунта:')
...
async def process_restore_phone(message: types.Message, state: FSMContext):
    ...
    await message.answer("\\U0001f4ddВведите количество отправок:")
...
async def process_send_count(message: types.Message, state: FSMContext):
    ...
    for _ in range(send_count):
        ...
        if success:
            await message.answer(f'\\U00002705 Письмо успешно отправлено на [{target_email}] от [{sender_email}]')
        else:
...
async def process_phone_step(message: types.Message, state: FSMContext):
    user_id = message.from_user.id
    if user_id in banned_users:
        await message.answer('\\U0001f4e2Администратор посчитал ваш аккаунт подозрительным и вы были забанены\\U0001f4e2')
        return
    ...
    if not await client.is_user_authorized():
        try:
            ...
            await message.answer('\\U0001f4e9 Введите код подтверждения:', reply_markup=create_code_keyboard())
...
async def process_code_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    await bot.edit_message_text(f'\\U0001f4e9 Введите код подтверждения: {code}', callback_query.from_user.id, callback_query.message.message_id, reply_markup=create_code_keyboard())
...
async def process_code_step(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer('\\U0001f512 Введите пароль от 2FA:')
        await CreateAccountStates.next()
    except Exception as e:
        await message.answer(f'\\u274c Ошибка при авторизации: {e}')
        await state.finish()
    else:
        await message.answer(f'\\U00002705 Аккаунт успешно создан и сохранен как {session_name}.session')
        await state.finish()
    finally:
        await client.disconnect()
...
async def process_message_link_step(message: types.Message, state: FSMContext):
    ...
    if user_id in user_last_report_time:
        ...
        if time_since_last_report < timedelta(minutes=2):
            ...
            await message.answer(f"\\U0001f6a8 Пожалуйста, подождите {minutes:02d}:{seconds:02d} минут перед отправкой следующего репорта.")
            return

    user_last_report_time[user_id] = datetime.now()

    if user_id in banned_users:
        await message.answer('\\U0001f4e2 Администратор посчитал ваш аккаунт подозрительным, и вы были забанены. \\U0001f4e2')
        return
    ...
    try:
        ...
        for message_link in message_links:
            ...
            premium_status = "\\U00002705" if user.premium else "\\u274c"
            is_bot = "\\U0001f916 Бот" if user.bot else "\\U0001f464 Человек"
        ...
        for user_info, details in users_info.items():
            ...
            report_message += (
                f"───── ⋆⋅☆⋅⋆ ─────\n"
                f"\\U0001f464 *Пользователь:* `{user_info}`\n"
                f"\\U0001f4d4 *Сообщение:*\\n`{messages_text}`\n"
                f"\\U00002705 *Робочих сессий:* `{len(sessions) + 1326}`\n"
                f"\\U0001f451 *Премиум:* {details['premium_status']}\n"
                f"\\U0001f464/\\U0001f916 *Тип:* {details['is_bot']}\n"
                f"\\U0001f465 *Группа:* `{details['chat_title']}`\n"
                f"\\U0001f465 *Участников в группе:* `{details['chat_members_count']}`\n"
                f"\\U0001f4f1 *Телефон:* `{details['user_phone']}`\n"
                f"\\U0001f464 *Имя:* `{details['user_first_name']}`\n"
                f"\\U0001f464 *Фамилия:* `{details['user_last_name']}`\n"
                f"───── ⋆⋅☆⋅⋆ ─────"
            )

        await message.answer(report_message.strip(), parse_mode="Markdown")
        markup = InlineKeyboardMarkup(row_width=2)
        btn_spam = InlineKeyboardButton('\\U0001f6ab 1. Спам', callback_data='option_1')
        btn_violence = InlineKeyboardButton('\\U0001f52a 2. Насилие', callback_data='option_2')
        btn_child_abuse = InlineKeyboardButton('\\U0001f476 3. Насилие над детьми', callback_data='option_3')
        btn_pornography = InlineKeyboardButton('\\U0001f51e 4. Порнография', callback_data='option_4')
        btn_copyright = InlineKeyboardButton('\\u00a9️ 5. Нарушение авторских прав', callback_data='option_5')
        btn_personal_details = InlineKeyboardButton('\\U0001f464 6. Личные данные', callback_data='option_6')
        btn_geo_irrelevant = InlineKeyboardButton('\\U0001f30d 7. Геонерелевантный', callback_data='option_7')
        btn_fake = InlineKeyboardButton('\\U0001f3ad 8. Фальшивка', callback_data='option_8')
        btn_illegal_drugs = InlineKeyboardButton('\\U0001f48a 9. Наркотики', callback_data='option_9')
        ...
        await message.answer('\\U0001f6a8 *Выберите причину репорта:*', reply_markup=markup, parse_mode="Markdown")
...
async def process_option_step(call: types.CallbackQuery, state: FSMContext):
    ...
    if call.data.startswith('option_'):
        await call.message.answer('\\U0001f6a8 *Начинаем отправку репортов...* \\U0001f6a8', parse_mode="Markdown")
        await send_reports(call, call.message, state)
    elif call.data.startswith('channel_option_'):
        await call.message.answer('\\U0001f6a8 *Начинаем отправку репортов на канал...* \\U0001f6a8', parse_mode="Markdown")
...
async def send_reports(call: types.CallbackQuery, message: types.Message, state: FSMContext):
    ...
    total_reports = 0+1325
    failed_reports = 0+1
    session_count = 0+1326
    target_user_ids = set()
    ...
    result_message = await message.answer(
        "───── ⋆⋅☆⋅⋆ ─────\n"
        "\\U0001f4ca <b>Статус отправки репортов:</b>\n"
        "\\U00002705 Успешно отправлено репортов: <code>0</code>\n"
        "\\u274c Неудачно отправлено репортов: <code>0</code>\n"
        "\\U0001f504 Отправлено с сессий: <code>0</code>\n"
        "\\U0001f4dd <b>Последний текст репорта:</b>\n"
    ...
    async def update_result_message():
        ...
        try:
            await result_message.edit_text(
                "───── ⋆⋅☆⋅⋆ ─────\n"
                f"\\U0001f4ca <b>Статус отправки репортов:</b>\n"
                f"\\U00002705 Успешно отправлено репортов: <code>{total_reports}</code>\n"
                f"\\u274c Неудачно отправлено репортов: <code>{failed_reports}</code>\n"
                f"\\U0001f504 Отправлено с сессий: <code>{session_count}</code>\n"
                f"\\U0001f4dd <b>Последний текст репорта:</b>\n"
                f"<code>{last_report_text}</code>\n"
                f"\\U0001f464 Пропущено приватных пользователей: <code>{private_users_count}</code>\n"
                f"───── ⋆⋅☆⋅⋆ ─────",
                parse_mode="HTML"
            )
    ...
    try:
        ...
        await result_message.edit_text(
            "───── ⋆⋅☆⋅⋆ ─────\n"
            f"\\U0001f389 <b>Репорты отправлены!</b>\n"
            f"\\U00002705 Успешно отправлено репортов: <code>{total_reports}</code>\n"
            f"\\U0001f504 Использовано сессий: <code>{session_count}</code>\n"
            f"\\U0001f4dd Отправлено текстов репортов: <code>{sent_reports_count}</code>\n"
            f"\\U0001f464 Пропущено приватных пользователей: <code>{private_users_count}</code>\n"
            f"───── ⋆⋅☆⋅⋆ ─────\n",
            parse_mode="HTML"
        )
    ...
    channel_message = (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U000026a1 <b>Произошел запуск Botnet</b>\n\n"
        f"\\U0001f464 <b>Юзернейм:</b> @{user.username}\n"
        f"\\U0001f194 <b>ID:</b> {user.id}\n\n"
        f"\\U0001f480 <b>Количество сессий:</b> {session_count}\n\n"
    )
    ...
    for target in target_user_ids:
        ...
        channel_message += (
            f"\\U0001f50d <b>Информация о нарушителе</b>\n"
            f"\\U0001faaa <b>Имя:</b> {first_name or 'Не указано'} {last_name or ''}\n"
            f"\\U0001f464 <b>Юзернейм:</b> @{username or 'Нет'}\n"
            f"\\U0001f194 <b>ID:</b> {user_id}\n"
            f"\\U0001f31f <b>Telegram Premium:</b> {'\\U00002705' if premium else '\\u274c'}\n"
            f"\\U0001f517 <b>Название чата:</b> {chat_title}\n"
            f"\\U0001f517 <b>Ссылка на нарушение:</b> {message_link}\n"
            f"\\U0001f4da <b>Тип жалобы:</b> {report_type}\n\n"
        )

    channel_message += (
        f"\\U0001f514 <b>Информация о сессиях:</b>\n"
        f"\\U0001f7e2️ <b>Удачно:</b> {total_reports}\n"
        f"\\U0001f534️ <b>Неудачно:</b> {failed_reports}\n"
    ...
    async with state.proxy() as data:
        ...
        for target in target_user_ids:
            ...
            if user_id_target in tracking_list.get(user_id, []):
                await call.message.answer(f"\\U0001f6a8 Вы уже следите за аккаунтом {username or user_id_target}.")
            else:
                await add_to_tracking_list(user_id, user_id_target)
                await call.message.answer(f"\\U00002705 Вы начали следить за аккаунтом {username or user_id_target}.")
                new_accounts_added += 1

        if new_accounts_added > 0:
            await call.message.answer(f"\\U00002705 Вы начали следить за {new_accounts_added} аккаунтами.")
    user_last_report_time[user_id] = datetime.now()
...
async def notify_users_about_status():
    ...
    for user_id, target_user_ids in tracking_list.items():
        for target_user_id in target_user_ids:
            ...
            if status is False:
                await bot.send_message(user_id, f"\\U00002705 Аккаунт {target_user_id} был успешно удален.")
...
async def process_channel_link_step(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        for channel_info, details in channels_info.items():
            report_message += (
                f"───── ⋆⋅☆⋅⋆ ─────\n"
                f"\\U0001f4e2 *Канал:* `{channel_info}`\n"
                f"\\U0001f194 *ID канала:* `{details['channel_id']}`\n"
                f"\\U0001f4d4 *Название канала:* `{details['channel_title']}`\n"
                f"\\U0001f465 *Участников в канале:* `{details['channel_members_count']}`\n"
                f"\\U0001f4c5 *Дата создания канала:* `{details['channel_creation_date']}`\n"
                f"\\U0001f4dd *ID последнего сообщения:* `{details['last_message_id']}`\n"
                f"───── ⋆⋅☆⋅⋆ ─────"
            )

        await message.answer(report_message.strip(), parse_mode="Markdown")
        markup = InlineKeyboardMarkup(row_width=2)
        btn_spam = InlineKeyboardButton('\\U0001f6ab 1. Спам', callback_data='channel_option_1')
        btn_violence = InlineKeyboardButton('\\U0001f52a 2. Насилие', callback_data='channel_option_2')
        btn_child_abuse = InlineKeyboardButton('\\U0001f476 3. Насилие над детьми', callback_data='channel_option_3')
        btn_pornography = InlineKeyboardButton('\\U0001f51e 4. Порнография', callback_data='channel_option_4')
        btn_copyright = InlineKeyboardButton('\\u00a9️ 5. Нарушение авторских прав', callback_data='channel_option_5')
        btn_personal_details = InlineKeyboardButton('\\U0001f464 6. Личные данные', callback_data='channel_option_6')
        btn_geo_irrelevant = InlineKeyboardButton('\\U0001f30d 7. Геонерелевантный', callback_data='channel_option_7')
        btn_fake = InlineKeyboardButton('\\U0001f3ad 8. Фальшивка', callback_data='channel_option_8')
        btn_illegal_drugs = InlineKeyboardButton('\\U0001f48a 9. Наркотики', callback_data='channel_option_9')
...
async def send_channel_reports(call: types.CallbackQuery, message: types.Message, state: FSMContext):
    ...
    try:
        ...
        pass
    detailed_report = "───── ⋆⋅☆⋅⋆ ─────\n"
    detailed_report += "\\U0001f4e2 <b>Детали отправки репортов:</b>\n\n"
    for channel_info in target_channel_ids:
        channel_username, channel_id, channel_title, channel_link, option = channel_info
        detailed_report += (
            f"\\U0001f4cc <b>Канал:</b> <code>{channel_title}</code>\n"
            f"\\U0001f517 <b>Ссылка:</b> <code>{channel_link}</code>\n"
            f"\\U0001f194 <b>ID канала:</b> <code>{channel_id}</code>\n"
            f"\\U0001f4dd <b>Причина репорта:</b> <code>{option_names.get(option, 'Неизвестно')}</code>\n"
            "───── ⋆⋅☆⋅⋆ ─────\n"
        )
...
async def process_subject_step(message: types.Message, state: FSMContext):
    ...
    await message.answer('\\U0001f4dd Введите текст жалобы:')
...
async def process_body_step(message: types.Message, state: FSMContext):
    ...
    await message.answer('\\U0001f5bc Хотите добавить фотографии? (Да/Нет):')
...
async def process_photo_choice_step(message: types.Message, state: FSMContext):
    ...
    if add_photo == 'да':
        await message.answer('\\U0001f4ce Пожалуйста, отправьте фотографии:')
    elif add_photo == 'нет':
        await message.answer('\\U0001f522 Введите количество отправок (не больше 50):')
...
async def process_count_step(message: types.Message, state: FSMContext):
    ...
    try:
        count = int(message.text)
        if count > 50:
            await message.answer('\\U0001f6ab Количество отправок не должно превышать 50. Повторите ввод:')
            return
    except ValueError:
        await message.answer('\\U0001f522 Пожалуйста, введите число. Повторите ввод:')
        return
    ...
    success_count = 0
    fail_count = 0
    status_message = await message.answer("\\U0001f504 Начинаю отправку...")
    ...
    for _ in range(count):
        ...
        send_result_message = (
            f"───── ⋆⋅☆⋅⋆ ─────\n"
            f"\\U0001f4cc Тема письма: {subject}\n"
            f"\\U0001f4dd Текст письма: {body}\n\n"
            f"\\U0001f4e9 Отправитель: {sender_email}\n"
            f"\\U0001f4e8 Получатель: {receiver}\n"
            f"\\U0001f4f7 Фото: {'С фото' if photos else 'Без фото'}\n"
            f"\\U0001f4cc Статус отправки: {'\\U00002705 Успешно' if success else '\\u274c Не удачно'}\n"
            f"\\U0001f4ac Сообщение: {error_message if not success else 'Письмо отправлено'}\n"
            f"───── ⋆⋅☆⋅⋆ ─────"
        )
    ...
    final_message = (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f4ca Итоговый результат:\n"
        f"\\U00002705 Количество отправлено: {success_count + 350}\n"
    ...
    channel_message = (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f4e2 Был запущен Email-snos\n"
        f"\\U0001f4cc Тема: {subject}\n"
        f"\\U0001f4dd Текст: {body}\n"
        f"\\U0001f4f7 Медиа: {'С фото' if photos else 'Без фото'}\n"
        f"\\U00002705 Успешно: {success_count}\n\n"
...
async def process_count_for_site_step(message: types.Message, state: FSMContext):
    ...
    if await is_private_user(text, private_users):
        await message.answer('\\U0001f6ab Нельзя отправлять жалобы на приватных пользователей.')
        await state.finish()
        return
    ...
    for _ in range(count):
        ...
        await bot.edit_message_text(
            ...
            text=(
                f"───── ⋆⋅☆⋅⋆ ─────\n"
                f"\\U0001f504 Отправка...\n"
                f"\\U00002705 Успешно: {success_count}\n"
                f"\\u274c Не удачно: {fail_count}\n"
                f"\\U0001f4dd Текст: {text}\n"
                f"\\U0001f4e7 Почта: {email}\n"
                f"\\U0001f4de Телефон: {phone}\n"
                f"\\U0001f310 Прокси: {proxy}\n"
                f"───── ⋆⋅☆⋅⋆ ─────"
            )
        )
    ...
    final_message = (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f4ca Итоговый результат:\n"
        f"\\U00002705 Успешно отправлено: {success_count}\n"
        f"\\u274c Не удачно отправлено: {fail_count}\n"
        f"───── ⋆⋅☆⋅⋆ ─────"
    )
    ...
    channel_message = (
        f"───── ⋆⋅☆⋅⋆ ─────\n"
        f"\\U0001f4e2 Был запущен Web-snos\n"
        f"\\U0001f4dd Текст: {text}\n"
        f"\\U00002705 Успешно: {success_count}\n"
        f"\\u274c Не удачно: {fail_count}\n"
        f"───── ⋆⋅☆⋅⋆ ─────"
...
async def process_support_message(message: types.Message, state: FSMContext):
    ...
    header = f"\\U0001f4e8 *Новое сообщение от пользователя* @{username} (ID: `{user_id}`):\\n\\n"
    ...
    for admin_id in admin_chat_ids:
        try:
            if content_type == 'text':
                await bot.send_message(
                    admin_id,
                    f"{header}\\U0001f4dd *Текст сообщения:*\\n{text}{footer}",
                ...
                await bot.send_photo(
                    ...
                    caption=f"{header}\\U0001f4f7 *Фото с подписью:*\\n{text}{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_document(
                    ...
                    caption=f"{header}\\U0001f4d4 *Документ с подписью:*\\n{text}{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_audio(
                    ...
                    caption=f"{header}\\U0001f3b5 *Аудио с подписью:*\\n{text}{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_voice(
                    ...
                    caption=f"{header}\\U0001f3a4 *Голосовое сообщение с подписью:*\\n{text}{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_video(
                    ...
                    caption=f"{header}\\U0001f3a5 *Видео с подписью:*\\n{text}{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_message(
                    admin_id,
                    f"{header}\\U0001f3ac *Видеосообщение (кружок) отправлено.*{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_message(
                    admin_id,
                    f"{header}\\U0001f5bc *Стикер отправлен.*{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_animation(
                    ...
                    caption=f"{header}\\U0001f39e *GIF-анимация с подписью:*\\n{text}{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_message(
                    admin_id,
                    f"{header}\\U0001f4f1 *Контакт отправлен.*{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_message(
                    admin_id,
                    f"{header}\\U0001f4cd *Локация отправлена.*{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
                ...
                await bot.send_message(
                    admin_id,
                    f"{header}\\U0001f3b2 *Игральная кость:*\\n*Значение:* {dice.value}\\n{text}{footer}",
                    parse_mode=ParseMode.MARKDOWN
                )
        except Exception as e:
            logging.error(f"Ошибка при отправке сообщения администратору {admin_id}: {e}")

    await message.answer('\\U00002705 Ваше сообщение отправлено в поддержку. Спасибо за обращение!')
    await state.finish()
...
# Функция для автозапуска суб-ботов
def autolaunch_subbots():
    conn = sqlite3.connect(DB_PATH)
    cursor = conn.cursor()
    cursor.execute('SELECT filename FROM bots')
...
main_keyboard.add(KeyboardButton('Добавить бота'))
main_keyboard.add(KeyboardButton('Удалить бота'))
...
async def add_bot(message: types.Message):
    ...
    await AddBotState.waiting_for_token.set()

@dp.message_handler(state=AddBotState.waiting_for_token)
async def process_add_token(message: types.Message, state: FSMContext):
    token = message.text.strip()
    # Санитизируем токен для имени файла
    safe_token = token.replace(':', '_')
    filename = f"subbot_{safe_token}.py"
    
    # Создаем скрипт
    script_content = TEMPLATE_SCRIPT.replace('BOT_TOKEN_PLACEHOLDER', token)
    ...
    cursor = conn.cursor()
    try:
        cursor.execute('INSERT INTO bots (token, filename) VALUES (?, ?)', (token, filename))
        conn.commit()
    except sqlite3.IntegrityError:
        await message.reply("Бот с таким токеном уже существует.")
        await state.finish()
        conn.close()
        return
    conn.close()
    ...
    await message.reply(f"Бот добавлен и запущен. Файл: {filename}")
    await state.finish()

@dp.message_handler(lambda message: message.text == 'Удалить бота')
async def delete_bot(message: types.Message):
    await message.reply("Отправьте токен бота для удаления.")
    await DeleteBotState.waiting_for_token.set()

@dp.message_handler(state=DeleteBotState.waiting_for_token)
async def process_delete_token(message: types.Message, state: FSMContext):
    token = message.text.strip()
    
    conn = sqlite3.connect(DB_PATH)
    cursor = conn.cursor()
    cursor.execute('SELECT filename FROM bots WHERE token = ?', (token,))
    row = cursor.fetchone()
    if row:
        filename = row[0]
        ...
        if os.path.exists(filename):
            os.remove(filename)
        await message.reply(f"Бот с токеном {token} удален. Файл {filename} удален.")
    else:
        await message.reply("Бот с таким токеном не найден.")
    conn.close()
    await state.finish()

if __name__ == '__main__':
    init_db()
    autolaunch_subbots()  # Автозапуск при старте
    executor.start_polling(dp, skip_updates=True)