...
import os, time
bot_token = "8561321074:AAE31isq5h4BteSIEG21FUsrn03lrBr6vsE"
...
async def demolition_callback(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    btn_website_complaint2 = InlineKeyboardButton('💻Web-snos 2.0💻', callback_data='website_complaint2')
